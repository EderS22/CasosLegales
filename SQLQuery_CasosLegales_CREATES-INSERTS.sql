...
VALUES	('01','AtlÃ¡ntida', '1', 1, GETDATE(), NULL, NULL),
		('02','ColÃ³n', '1', 1, GETDATE(), NULL, NULL),
		('03','Comayagua', '1', 1, GETDATE(), NULL,NULL),
		('04','CopÃ¡n', '1', 1, GETDATE(), NULL, NULL),
		('05','CortÃ©s', '1', 1, GETDATE(), NULL, NULL),
		('06','Choluteca', '1', 1, GETDATE(), NULL, NULL),
		('07','El ParaÃ­so', '1', 1, GETDATE(), NULL, NULL),
		('08','Francisco MorazÃ¡n', '1', 1, GETDATE(), NULL, NULL),
		('09','Gracias a Dios', '1', 1, GETDATE(), NULL, NULL),
		('10','IntibucÃ¡', '1', 1, GETDATE(), NULL, NULL),
		('11','Islas de la BahÃ­a', '1', 1, GETDATE(), NULL, NULL),
		...
		('16','Santa BÃ¡rbara', '1', 1, GETDATE(), NULL, NULL),
...
VALUES	('1','0101','La Ceiba', '1', 1, GETDATE(), NULL, GETDATE()),
		...
		('18', '1806', 'MorazÃ¡n', '1', 1, GETDATE(), NULL, GETDATE()),
...
VALUES ('123456789', 'Juan',	'PÃ©rez',	'M', '123456789', 'juan.perez@gmail.com',		'1990-01-01', 1, 1, 1, 'Calle Principal 123',	1),
		('987654321', 'MarÃ­a',	'LÃ³pez',	'F', '987654321', 'maria.lopez@gmail.com',		'1995-05-10', 2, 2, 2, 'Avenida Secundaria 456',1),
		('555555555', 'Pedro',	'GonzÃ¡lez', 'M', '555555555', 'pedro.gonzalez@gmail.com',	'1985-12-15', 3, 1, 3, 'Plaza Central 789',		1),
		('111111111', 'Ana',	'GarcÃ­a',	'F', '111111111', 'ana.garcia@gmail.com',		'1988-06-20', 2, 2, 1, 'Calle Secundaria 234',	1),
		('222222222', 'Luis',	'MartÃ­nez', 'M', '222222222', 'luis.martinez@gmail.com',	'1992-09-08', 1, 3, 2, 'Avenida Principal 567', 1),
		('333333333', 'Laura', 'RodrÃ­guez', 'F', '333333333', 'laura.rodriguez@gmail.com',	'1997-03-12', 3, 1, 3, 'Plaza Secundaria 890',	1);
GO
...
VALUES ('123456789', 'Juan',	'PÃ©rez',		'M', '123456789', 'juan.perez@example.com',		'1990-01-01', 1, 1, 'Calle Principal 123',		1, 0, 0, 1),
		('987654321', 'MarÃ­a',	'LÃ³pez',		'F', '987654321', 'maria.lopez@example.com',	'1995-05-10', 2, 2, 'Avenida Secundaria 456',	0, 1, 0, 1),
		('555555555', 'Pedro',	'GonzÃ¡lez',		'M', '555555555', 'pedro.gonzalez@example.com', '1985-12-15', 3, 1, 'Plaza Central 789',		1, 0, 0, 1),
		('111111111', 'Ana',	'GarcÃ­a',		'F', '111111111', 'ana.garcia@example.com',		'1988-06-20', 2, 2, 'Calle Secundaria 234',		1, 0, 1, 1),
		('222222222', 'Luis',	'MartÃ­nez',		'M', '222222222', 'luis.martinez@example.com',	'1992-09-08', 1, 3, 'Avenida Principal 567',	0, 1, 0, 1),
		('333333333', 'Laura',	'RodrÃ­guez',	'F', '333333333', 'laura.rodriguez@example.com','1997-03-12', 3, 1, 'Plaza Secundaria 890',		0, 0, 1, 1);
GO
...
VALUES ('111111111', 'Juan',	'PÃ©rez',	'M', '111111111', 'juan.perez@example.com',			'1990-01-01', 1, 1, 'Calle Principal 123',		1),
		('222222222', 'MarÃ­a',	'LÃ³pez',	'F', '222222222', 'maria.lopez@example.com',		'1995-05-10', 2, 2, 'Avenida Secundaria 456',	1),
		('333333333', 'Pedro',	'GonzÃ¡lez', 'M', '333333333', 'pedro.gonzalez@example.com',		'1985-12-15', 3, 1, 'Plaza Central 789',		1),
		('444444444', 'Ana',	'GarcÃ­a',	'F', '444444444', 'ana.garcia@example.com',			'1992-06-20', 2, 2, 'Calle Secundaria 234',		1),
		('555555555', 'Luis',	'MartÃ­nez', 'M', '555555555', 'luis.martinez@example.com',		'1997-09-08', 1, 3, 'Avenida Principal 567',	1),
		('666666666', 'Laura',	'RodrÃ­guez','F', '666666666', 'laura.rodriguez@example.com',	'1994-03-12', 3, 1, 'Plaza Secundaria 890',		1),
		('777777777', 'Carlos', 'GÃ³mez',	'M', '777777777', 'carlos.gomez@example.com',		'1989-11-25', 2, 2, 'Calle Principal 789',		1),
		('888888888', 'MarÃ­a',	'Torres',	'F', '888888888', 'maria.torres@example.com',		'1993-07-18', 3, 1, 'Avenida Secundaria 456',	1),
		('999999999', 'Manuel', 'SÃ¡nchez',	'M', '999999999', 'manuel.sanchez@example.com',		'1991-04-30', 1, 3, 'Plaza Central 789',		1),
		('101010101', 'Susana', 'LÃ³pez',	'F', '101010101', 'susana.lopez@example.com',		'1996-08-05', 2, 2, 'Calle Secundaria 234',		1);
GO

    ...
    public partial class DB_CasoslegalesContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<tbCasos>(entity =>
            {
                ...
                entity.Property(e => e.caso_Estado)
                    .IsRequired()
                    .HasDefaultValueSql("((1))");
                ...
                entity.HasOne(d => d.caso_AbogadoDemandadoNavigation)
                    .WithMany(p => p.tbCasoscaso_AbogadoDemandadoNavigation)
                    .HasForeignKey(d => d.caso_AbogadoDemandado)
                    .HasConstraintName("FK_CALE_tbCasos_CALE_tbAbogadosJueces_caso_AbogadoDemandado");

                entity.HasOne(d => d.caso_AbogadoDemandanteNavigation)
                    .WithMany(p => p.tbCasoscaso_AbogadoDemandanteNavigation)
                    .HasForeignKey(d => d.caso_AbogadoDemandante)
                    .HasConstraintName("FK_CALE_tbCasos_CALE_tbAbogadosJueces_caso_AbogadoDemandante");

                entity.HasOne(d => d.caso_JuezNavigation)
                    .WithMany(p => p.tbCasoscaso_JuezNavigation)
                    .HasForeignKey(d => d.caso_Juez)
                    .HasConstraintName("FK_CALE_tbCasos_CALE_tbAbogadosJueces_caso_Juez");

                entity.HasOne(d => d.caso_UsuCreacionNavigation)
                    .WithMany(p => p.tbCasoscaso_UsuCreacionNavigation)
                    .HasForeignKey(d => d.caso_UsuCreacion)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_CALE_tbCasos_ACCE_tbUsuarios_UserCreate");

                entity.HasOne(d => d.caso_UsuModificacionNavigation)
                    .WithMany(p => p.tbCasoscaso_UsuModificacionNavigation)
                    .HasForeignKey(d => d.caso_UsuModificacion)

...
export class CrearComponent {
  ...
  constructor(
    ...
    this.validationform = this.formBuilder.group({
      emsa_Nombre: ['', [Validators.required, Validators.pattern('[a-zA-Z0-9]+')]],
      emsa_RTN: ['', [Validators.required, Validators.pattern('[a-z A-Z 0-9]+')]],
      muni_Id: ['', [Validators.required]],
      emsa_Direccion: ['', [Validators.required]],
      emsa_RepresentanteNombre: ['', [Validators.required]],
